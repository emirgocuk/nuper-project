...
Bu nedenle AutoMetrol mimarisinde yapay zekâ bir **"otobüs şoförü" değil, yan koltukta haritaya bakan bir "rehberdir"**:
...
* CMM operatörünün elleri yağlıyken veya kumanda tutarken bilgisayar faresine uzanmasını engellemek için yerel `whisper.cpp` modeli arka planda komut dinler:
  * *"AutoMetrol, 2 numaralı pabucu Keep-Out alanı yap."*
