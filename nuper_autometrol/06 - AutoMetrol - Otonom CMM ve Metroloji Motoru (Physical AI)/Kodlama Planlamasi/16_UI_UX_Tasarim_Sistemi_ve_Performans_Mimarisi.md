...
AutoMetrol arayüzü geleneksel CMM programlarına **asla benzemez**. Referans alınan modern araçlar:
...
│    • AutoMetrol: STEP ve PDF'i at, "Generate Path" de; karmaşık DMIS        │
...
| Yasaklanan Kaynak Canavarı | Neden Yasak? | AutoMetrol Çözümü |
|---|---|---|
...
```
┌────────────────────────────────────────────────────────────────────────────────────────────────┐
│ [Üst Bar 48px]  AutoMetrol v0.1.0-alpha  |  CMM: LK-Altera 10.7.6  |  Stylus: Ø2x20mm  [RAM: 110MB]│
├──────────────────┬─────────────────────────────────────────────────────────────┬───────────────┤
...
* **Sol:** AutoMetrol Logosu + Parça Adı (`Govde_OP20.step`).
