...
> **"AutoMetrol kod tabanını inşa ederken sahada mikron seviyesinde doğruluğu, çarpışmasız çalışmayı ve yüksek performansı garanti eden 6 temel alt sistem ve bunların düşük seviyeli (low-level) teknik çözüm mimarisi."**
...
```rust
// autometrol-kinematics/src/probe_tree.rs
