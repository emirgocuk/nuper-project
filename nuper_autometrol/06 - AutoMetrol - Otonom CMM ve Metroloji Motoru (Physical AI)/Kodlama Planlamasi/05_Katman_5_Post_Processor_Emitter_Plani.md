# 💻 Katman 5 Planı: Post-Processor Derleyici (`autometrol-emitter`)
...
`autometrol-emitter` kütüphanesi, sistemin **Backend / Code Generator** katmanıdır. Görevi:
...
- `autometrol-emitter/templates/` altına sadece yeni bir şablon dosyası (`wenzel_wm.tera`) eklenir.
