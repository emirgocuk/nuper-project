...
> **"AutoMetrol'ü basit bir CAM script'inden ayıran ve havacılık/savunma (AS9100, MIL-STD) düzeyinde resmi geçerlilik kazandıran 5 uluslararası metroloji standardı, matematiksel belirsizlik bütçesi (GUM) ve kabul karar mimarisi."**
...
| STEP Standardı | İçerik Kapsamı | AutoMetrol Entegrasyonu |
|---|---|---|
...
|---|---|---|
| **Belirsizlik & Simülasyon** | ISO 15530-3 / GUM | `autometrol-kinematics`: TUR doğrulama denetleyicisi |
| **Uç Değer & Filtreleme** | ISO 16610-21 / 31 | `autometrol-kinematics`: Robust Gaussian filtreleme fonksiyonu |
| **Datum Kinematiği** | ISO 5459 / ASME Y14.5 | `autometrol-ast`: 6 DoF rank kilitlenme matrisi |
| **CAD Veri Protokolü** | ISO 10303-242 (AP242) | `autometrol-brep`: Semantik PMI ayrıştırıcı ve AP214 fallback |
| **Kalite Karar Eşiği** | ISO 14253-1 | `autometrol-post`: Guard-banding uygunluk değerlendirmesi |
