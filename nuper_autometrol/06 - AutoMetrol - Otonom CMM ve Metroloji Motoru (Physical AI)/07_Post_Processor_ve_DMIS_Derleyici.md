...
AutoMetrol, ölçüm yolunu doğrudan tek bir yazılıma bağımlı üretmez. Önce bellek içinde üretici-bağımsız bir **Nötr Teftiş Ağacı (Neutral Inspection AST)** kurar. Bu ağaç daha sonra Rust tabanlı bir şablon motoru (**Tera / Jinja**) ile hedef CMM kontrol ünitesine derlenir:
...
Her AutoMetrol programı zorunlu olarak iki aşamadan oluşur:
...
AutoMetrol tarafından derlenen, sahada doğrudan çalıştırılabilir eksiksiz bir DMIS program kütüğü:
...
Atölyelerde CMM tablasına tek bir parça değil, fikstür pleytine dizilmiş 4, 8 veya 16 adet parça aynı anda bağlanır. AutoMetrol tek tuşla dizi döngüsü üretir:
