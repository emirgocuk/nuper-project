---
title: Nuper Industries İkinci Beyin & Obsidian Vault İndeksi
type: moc
updated: 2026-09-21
tags:
  - obsidian-vault
...
```mermaid
graph TD
    Home["🏠 00 - Vault Ana İndeksi"] --> Strategy["🏛️ [[Nuper Stratejik Marka Mimarisi ve Gelecek Tasarımı]]"]
    Home --> Manifesto["🛡️ [[Nuper Marka Rehberi ve Yaratıcılık Manifestosu]]"]
    Home --> Kitap["📖 [[Kitap - Yaratıcılık - Onur Yanık]]"]
    Home --> Engine["⚡ [[innovationEnginePlan]] (AI İnovasyon Fabrikası)"]
    
    Strategy -.->|İsim & Portföy Mimarisi| Manifesto
    Manifesto -.->|Doktrin & İlkeler| Engine
    Kitap -.->|Bilimsel Temel| Strategy
    
    Home --> Brief["🎯 [[projectbrief]]"]
    Home --> Product["📦 [[productContext]]"]
    Home --> Arch["🏗️ [[systemPatterns]]"]
    Home --> Tech["💻 [[techContext]]"]
    Home --> Active["⚡ [[activeContext]]"]
