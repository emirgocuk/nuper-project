    ...
    return (
        <div className="min-h-screen pt-24 pb-12 bg-gray-50">
            <div className="max-w-4xl px-4 mx-auto">
                <div className="mb-8">
                    <h1 className="text-3xl font-bold font-heading text-nuper-dark-blue">Fikir Başvurularım</h1>
                    <p className="text-gray-600 mt-2">Gönderdiğiniz tüm fikirlerin durumunu buradan takip edebilirsiniz.</p>
                </div>
                ...
                <div className="flex flex-col items-center justify-center p-12 text-center bg-white rounded-lg shadow-sm border border-gray-200">
                    ...
                    <h3 className="text-lg font-medium text-gray-900">Henüz Bir Fikir Başvurunuz Yok</h3>
                    <p className="mt-1 max-w-sm text-gray-500">
                        Yeni bir fikir mi var? Hemen fikrinizi paylaşın ve destek alın.
                    </p>
