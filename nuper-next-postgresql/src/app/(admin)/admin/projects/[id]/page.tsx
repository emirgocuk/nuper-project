...
export default function ProjectDetailPage({ params }: { params: { id: string } }) {
    ...
    // In real app: const project = await prisma.project.findUnique(...)

    return (
        <div className="max-w-4xl mx-auto space-y-6">
            <div className="flex items-center justify-between">
                <h1 className="text-3xl font-bold font-heading">Proje Detayı</h1>
                <Button variant="outline" onClick={() => router.back()}>Geri Dön</Button>
            </div>

            <Card>
                <CardHeader>
                    <CardTitle>Proje Başlığı: Test Proje</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                    ...
                    <div>
                        ...
                        <div className="p-4 bg-gray-50 rounded-lg min-h-[200px]">
                            <p>Proje içeriği burada görünecek (EditorJS JSON render).</p>
                        </div>
                    </div>
