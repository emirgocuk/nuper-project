...
Source: https://antigravity.codes/rules/rust/rust-webassembly-development

## AI Worker Instructions
When the user requests functionality related to Rust WebAssembly (WASM) Development, follow these guidelines and utilize this context.
...
# Cheqd
Enable AI Agents to be trusted, verified, prevent fraud, protect your reputation, and more through [cheqd's](https://cheqd.io) Trust Registries and Credentials.
