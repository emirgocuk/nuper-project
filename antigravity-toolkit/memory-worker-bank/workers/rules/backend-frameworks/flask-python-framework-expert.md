...
Source: https://antigravity.codes/rules/backend-frameworks/flask-python-framework

## AI Worker Instructions
When the user requests functionality related to Flask Python Framework Expert, follow these guidelines and utilize this context.
