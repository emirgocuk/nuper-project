...
const About = ({ darkMode }) => {
  return (
    <section className={`${darkMode ? 'bg-nuper-dark text-nuper-light-text' : 'bg-white text-gray-900'} py-16`}>
      <div className="max-w-4xl mx-auto px-4">
        <h2 className={`text-3xl font-heading font-bold text-center mb-6 ${darkMode ? 'text-nuper-light-text' : 'text-nuper-blue'}`}>Nuper Nedir?</h2>
        ...
        <div className="mt-8">
          <h3 className={`text-2xl font-heading font-semibold mb-4 ${darkMode ? 'text-nuper-light-text' : 'text-nuper-blue'}`}>Misyonumuz</h3>
          <p className="text-lg leading-relaxed">
