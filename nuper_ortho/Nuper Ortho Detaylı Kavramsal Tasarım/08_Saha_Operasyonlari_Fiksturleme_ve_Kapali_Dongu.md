...
Nuper Ortho arayüzünde operatörün tezgahtaki donanımını 10 saniyede seçmesini sağlayan **"Prob Montaj Sihirbazı (Stylus Configurator)"** modülü yer alır.
...
```
[ Nuper Ortho ] ──► [ CMM Teftiş ] ──► [ CSV / Q-DAS Raporu ]
                           │                      │
                           ▼                      │
