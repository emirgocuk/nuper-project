# 🔄 Katman 3 Planı: Kinematik ve Örnekleme Motoru (`ortho-kinematics`)
...
`ortho-kinematics` kütüphanesi, sistemin **Fizik ve Örnekleme** katmanıdır. Görevi:
...
```rust
// ortho-kinematics/src/ph10_solver.rs
use glam::DVec3;
...
```rust
// ortho-kinematics/src/sampler.rs
use glam::DVec3;
