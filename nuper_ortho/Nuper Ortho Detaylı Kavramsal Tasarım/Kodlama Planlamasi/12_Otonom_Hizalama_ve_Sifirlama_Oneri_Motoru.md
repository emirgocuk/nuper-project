...
Nuper Ortho, STEP dosyasını yüklediği anda geometriyi tarar ve 6 serbestlik derecesini ($T_x, T_y, T_z, R_x, R_y, R_z$) en düşük açısal hata yayılımıyla (error propagation) kilitleyecek en kararlı elemanları puanlar:
...
```plaintext
$$ ============================================================
 Nuper Ortho OTOMATIK ON-HIZALAMA (3-2-1 ALIGNMENT RECIPE)
$$ ============================================================
MODE/MAN
SNSET/APPRCH, 5.0
SNSET/RETRCT, 5.0
