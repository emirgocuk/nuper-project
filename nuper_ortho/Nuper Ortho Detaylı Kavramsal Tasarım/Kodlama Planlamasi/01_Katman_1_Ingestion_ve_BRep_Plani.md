# 📐 Katman 1 Planı: Girdi ve Geometrik Ayrıştırma (`ortho-brep`)
...
`ortho-brep` kütüphanesi, sistemin **Lexer/Parser** katmanıdır. Görevi:
...
```rust
// ortho-brep/src/ffi.rs
#[cxx::bridge(namespace = "Nuper Ortho::occt")]
pub mod ffi {
    #[derive(Debug, Clone)]
