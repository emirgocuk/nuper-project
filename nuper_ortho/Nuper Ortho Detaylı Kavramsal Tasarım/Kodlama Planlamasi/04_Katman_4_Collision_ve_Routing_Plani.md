# 🛡️ Katman 4 Planı: Emniyet Zarfı ve Çarpışmasız Rota (`ortho-router`)
...
`ortho-router` kütüphanesi, sistemin **Emniyet ve Optimizasyon** katmanıdır. Görevi:
...
```rust
// ortho-router/src/shank_collision.rs
use glam::DVec3;
...
```rust
// ortho-router/src/trajectory.rs
use glam::DVec3;
