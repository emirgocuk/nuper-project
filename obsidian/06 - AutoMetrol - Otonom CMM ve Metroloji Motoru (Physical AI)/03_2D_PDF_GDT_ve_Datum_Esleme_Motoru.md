...
AutoMetrol, gizlilik ve savunma regülasyonları gereği internete bağlanmadan (**air-gapped**), yerel donanımda (CPU veya yerel GPU) çalışan hafif bir **Vision-LLM / OCR (GGUF formatında)** hattı kullanır:
